...
<h2><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90" class="logo"><path class="inner" fill="#0a4de5" d="M47.6,70.9c-1.1,2.3-4.1,2.8-5.9,1L16.1,46.5c-1.5-1.6-1.4-4.1,0.3-5.4l3.4-3.4c1.3-1.1,3.2-1.1,4.6,0
	...
	<?php if ( isset( $_GET['sl_activation'] ) && ( 'false' === sanitize_text_field( wp_unslash( $_GET['sl_activation'] ) ) ) ) : // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
		<div class="error">
			...
			<?php else : ?>
				<p>There was an error validating your license. Please make sure you're using a valid one or contact us and we'll help: <a href="mailto:nerds@simplelms.co?subject=Invalid SimpleLMS license.">nerds@simplelms.co</a></p>
			<?php endif; ?>
		</div>
	<?php endif; ?>

<nav class="nav-tab-wrapper">
	<a href="?page=simple-lms&amp;tab=general" class="nav-tab<?php echo esc_html( 'general' === $active_tab ? ' nav-tab-active' : '' ); ?>">General</a>
	<a href="?page=simple-lms&amp;tab=buttons" class="nav-tab<?php echo esc_html( 'buttons' === $active_tab ? ' nav-tab-active' : '' ); ?>">Buttons</a>
	<a href="?page=simple-lms&amp;tab=graphs" class="nav-tab<?php echo esc_html( 'graphs' === $active_tab ? ' nav-tab-active' : '' ); ?>">Graphs</a>
	<a href="?page=simple-lms&amp;tab=advanced" class="nav-tab<?php echo esc_html( 'advanced' === $active_tab ? ' nav-tab-active' : '' ); ?>">Advanced</a>
</nav>
...
<div class="content">
	...
	if ( simplelms_is_production() ) {
		...
		include 'simple-lms-admin-settings-license-status.php';
	}
...
<div class="sidebar">
	...
	<?php if ( ! defined( 'SIMPLELMS_IS_ACTIVATED' ) || ! SIMPLELMS_IS_ACTIVATED ) : ?>
	<!-- FREE: -->
	<div class="postbox">
		<h2><span>Update to <?php echo esc_html( SIMPLELMS_PRODUCT_NAME ); ?> PRO</span></h2>
		<div class="inside">
			...
			<p><a href="<?php echo esc_html( SIMPLELMS_STORE_URL ); ?>">Check out all the benefits</a></p>
		</div>
	</div>
	...
	<div class="postbox">
		...
		<div class="inside">
			<?php if ( ! SIMPLELMS_IS_ACTIVATED ) : ?>
				<!-- FREE: -->
				<p>Need help? We’ve got <a href="https://help.ithemes.com/hc/en-us/categories/360004523854-SimpleLMS" target="_blank">a complete support section</a> on our website to help you find what you’re looking for. Need more? Our <a href="<?php echo esc_html( SIMPLELMS_STORE_URL ); ?>">PRO version</a> comes with email support, but feel free to ping us on the <a href="https://wordpress.org/support/plugin/<?php echo esc_html( SIMPLELMS_PREFIX ); ?>">WordPress support forum</a>.</p>
			<?php else : ?>
				<!-- PREMIUM: -->
				<p>Need help? We’ve got <a href="https://help.ithemes.com/hc/en-us/categories/360004523854-SimpleLMS" target="_blank">a complete support section</a> on our website to help you find what you’re looking for. Still need help or found a bug? <a href="mailto:nerds@simplelms.co">Let us know</a>.</p>
			<?php endif; ?>
		</div>
	</div>

	<?php if ( simplelms_is_production() && SIMPLELMS_IS_ACTIVATED ) : ?>
		<div class="postbox">
			<div class="inside">
...
<hr>
<p>If you like <?php echo esc_html( SIMPLELMS_PRODUCT_NAME ); ?>, please <a href="https://wordpress.org/support/view/plugin-reviews/<?php echo esc_html( SIMPLELMS_PREFIX ); ?>">leave us a ★★★★★ rating</a>. Your votes really make a difference! Thanks.</p>
