	...
	<?php if (isset($_GET['sl_activation']) && ('false' === sanitize_text_field(wp_unslash($_GET['sl_activation'])))): // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
		<div class="error">
			<?php if (isset($_GET['message'])): // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
				<p><?php echo wp_kses_post(urldecode(sanitize_text_field(wp_unslash($_GET['message'])))); ?>
	</p>
	<?php // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
			<?php
	else: ?>
	<p>There was an error validating your license. Please make sure you're using a valid one or contact us and we'll
		help: <a
			href="mailto:ryan.waterbury@onedog.solutions?subject=Invalid SimpleLMS license.">ryan.waterbury@onedog.solutions</a>
	</p>
	<?php
	endif; ?>
</div>
...
<div class="sidebar">
	...
	<div class="postbox">
		...
		<div class="inside">
			...
			<form
				action="//wpcomplete.us13.list-manage.com/subscribe/post?u=aa3f8a628a4c1c32b221a6399&amp;id=a3f8cf0350"
				...
				<div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text"
						name="b_aa3f8a628a4c1c32b221a6399_a3f8cf0350" tabindex="-1" value=""></div>
				<input type="email" value="" name="EMAIL" placeholder="Email Address" class="required email"
					id="mce-EMAIL">
	...
	<div class="postbox">
		...
		<div class="inside">
			<?php if (!SIMPLE_LMS_IS_ACTIVATED): ?>
			<!-- FREE: -->
			<p>Need help? We’ve got <a href="https://onedog.solutions/support" target="_blank">a complete support
					section</a> on our website to help you find what you’re looking for. Need more? Our <a
					href="<?php echo esc_html(SIMPLE_LMS_STORE_URL); ?>">PRO version</a> comes with email support, but
				feel free to ping us on the <a
					href="https://wordpress.org/support/plugin/<?php echo esc_html(SIMPLE_LMS_PREFIX); ?>">WordPress
					support forum</a>.</p>
			<?php
else: ?>
			<!-- PREMIUM: -->
			<p>Need help? We’ve got <a href="https://onedog.solutions/support" target="_blank">a complete support
					section</a> on our website to help you find what you’re looking for. Still need help or found a bug?
				<a href="mailto:ryan.waterbury@onedog.solutions">Let us know</a>.</p>
			<?php
endif; ?>
		</div>
	</div>

	<?php if (simple_lms_is_production() && SIMPLE_LMS_IS_ACTIVATED): ?>
	<div class="postbox">
		<div class="inside">
			<p>Want to change your license URL? Manage your license by logging in <a
					href="https://onedog.solutions/account">here</a>.</p>
		</div>
	</div>
	<?php
endif; ?>
...
<hr>
<p>If you like
	<?php echo esc_html(SIMPLE_LMS_PRODUCT_NAME); ?>, please <a
		href="https://wordpress.org/support/view/plugin-reviews/<?php echo esc_html(SIMPLE_LMS_PREFIX); ?>">leave us a
		★★★★★
		rating</a>. Your votes really make a difference! Thanks.
</p>
