 ...
 * Mirrors the patterns used by pp-advanced-tabs and pp-gravity-form.
 *
...
// BB stores colors without the leading `#`; `show_alpha` stores rgba() strings.
if ( ! function_exists( 'slms_color' ) ) {
	function slms_color( $value ) {
		if ( empty( $value ) ) {
			return '';
		}
		// Already a full CSS value (rgba / rgb / named color)?
