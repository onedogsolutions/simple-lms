...
class Guard
{
    ...
    public static function guard_singular()
    {
        ...
        $courses   = Access::resolve_courses($post_id);
        $course_id = !empty($courses) ? (int) $courses[0] : $post_id;
    ...
    private static function denied_markup($post)
    {
        ...
        $courses   = Access::resolve_courses($post->ID);
        $course_id = !empty($courses) ? (int) $courses[0] : $post->ID;
